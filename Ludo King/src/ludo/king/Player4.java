...
public class Player4 extends Player{
    ...
    Player4(Pion pion1,Pion pion2,Pion pion3,Pion pion4){
        this.pion1=pion1;
        this.pion2=pion2;
        this.pion3=pion3;
        this.pion4=pion4;
    ...
    public int[][] getRoadMap(){
        int[][] array={{13,6},{12,6},{11,6},{10,6},{9,6},{8,5},{8,4},{8,3},{8,2},{8,1},{8,0},{7,0},{6,0}
        ,{6,1},{6,2},{6,3},{6,4},{6,5},{5,6},{4,6},{3,6},{2,6},{1,6},{0,6},{0,7},{0,8}
        ,{1,8},{2,8},{3,8},{4,8},{5,8},{6,9},{6,10},{6,11},{6,12},{6,13},{6,14},{7,14},{8,14},{8,13}
        ,{8,12},{8,11},{8,10},{8,9},{9,8},{10,8},{11,8},{12,8},{13,8},{14,8},{14,7},{13,7},{12,7},{11,7}
        ,{10,7},{9,7},{8,7}};
        return array;
    }
